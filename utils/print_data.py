...
def print_data(message: Message, data: Dict) -> None:
    ...
    text_message = ('<b><u>Исходные данные:</u></b>\n'
    ...
    if data['sort'] == 'DISTANCE':
        bot.send_message(message.chat.id, text_message +
                         ...
                         f'• Конец диапазона от центра: {data["landmark_out"]}', parse_mode="html")

    else:
        bot.send_message(message.chat.id, text_message, parse_mode="html")

    bot.send_message(message.chat.id, "<b>Выдаю информации по отелям.</b>\nЕсли процесс долгий, пожалуйста подождите :)", parse_mode="html")
